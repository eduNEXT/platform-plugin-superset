#!/usr/bin/env python
"""
Package metadata for platform_plugin_superset.
"""
import os
import re
import sys
...
VERSION = get_version("platform_plugin_superset", "__init__.py")
...
setup(
    ...
    version=VERSION,
    description="""An Open edX plugin to integrate Superset with Open edX""",
    long_description=README + "\n\n" + CHANGELOG,
    author="eduNEXT",
    author_email="technical@edunext.co",
    url="https://github.com/eduNEXT/platform-plugin-superset",
    packages=find_packages(
        include=["platform_plugin_superset", "platform_plugin_superset.*"],
        exclude=["*tests"],
    ),
