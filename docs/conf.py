...
"""
platform-plugin-superset documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'platform-plugin-superset',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/eduNEXT/platform-plugin-superset",
...
#
# html_title = 'platform-plugin-superset v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'An Open edX plugin to integrate Superset with Open edX',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'platform_plugin_superset'),
                os.path.join(root_path, 'platform_plugin_superset/migrations')])
